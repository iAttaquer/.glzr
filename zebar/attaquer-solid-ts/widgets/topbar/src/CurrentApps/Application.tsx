...
const Application: Component<ApplicationProps> = (props) => {
  ...
  const handleAppClick = () => {
    ...
    props.glazewm.runCommand(
      `shell-exec %userprofile%/.glzr/zebar/attaquer-solid-ts/dist/topbar/assets/scripts/FocusWindow.ahk ${props.window.handle}`,
      // `shell-exec %userprofile%/AppData/Roaming/zebar/downloads/iattaquer.attaquer@2.0.0/dist/topbar/assets/scripts/FocusWindow.ahk ${props.window.handle}`,
    );
  };
